...
var _Grzx = _interopRequireDefault(__webpack_require__(/*! common/Grzx.js */ 16));
var _LyfwFmq = _interopRequireDefault(__webpack_require__(/*! common/LYFW/LyfwFmq.js */ 17));
var _LyfwCwd = _interopRequireDefault(__webpack_require__(/*! common/LYFW/LyfwCwd.js */ 18));

var _BcfwZyx = _interopRequireDefault(__webpack_require__(/*! common/BCFW/BcfwZyx.js */ 19));
var _ZYX = _interopRequireDefault(__webpack_require__(/*! common/ZYX.js */ 20));
var _scenicSpotDistribution = _interopRequireDefault(__webpack_require__(/*! common/scenicSpotDistribution.js */ 21));
var _changeImage = _interopRequireDefault(__webpack_require__(/*! common/changeImage.js */ 22));
var _overallSituation = _interopRequireDefault(__webpack_require__(/*! common/overallSituation.js */ 1868));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function ownKeys(object, enumerableOnly) {var keys = Object.keys(object);if (Object.getOwnPropertySymbols) {var symbols = Object.getOwnPropertySymbols(object);if (enumerableOnly) symbols = symbols.filter(function (sym) {return Object.getOwnPropertyDescriptor(object, sym).enumerable;});keys.push.apply(keys, symbols);}return keys;}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};if (i % 2) {ownKeys(Object(source), true).forEach(function (key) {_defineProperty(target, key, source[key]);});} else if (Object.getOwnPropertyDescriptors) {Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));} else {ownKeys(Object(source)).forEach(function (key) {Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));});}}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;} //全局js文件

_vue.default.config.productionTip = false;

// Vue.prototype.$store=store;  //登录
_vue.default.prototype.$oSit = _overallSituation.default; //全局文件
_vue.default.prototype.$Czc = _Czc.default; //登录
...
//模拟异步请求数据 - 出租车
var czc = function czc(type) {
  return new Promise(function (resolve) {
    setTimeout(function () {
      resolve(_Czc.default[type]);
    }, 500);
  });
};

//模拟异步请求数据 - 个人中心
var grzx = function grzx(type) {
  return new Promise(function (resolve) {
    setTimeout(function () {
      resolve(_Grzx.default[type]);
    }, 500);
  });
};
...
//模拟异步请求数据 - 旅游服务
var sceniclist = function sceniclist(type) {
  return new Promise(function (resolve) {
    setTimeout(function () {
      resolve(_scenicSpotDistribution.default[type]);
    }, 500);
  });
};

//模拟异步请求数据 - 包车服务
var bcfwzyx = function bcfwzyx(type) {
  return new Promise(function (resolve) {
    setTimeout(function () {
      resolve(_BcfwZyx.default[type]);
    }, 500);
  });
};

var zyxinfo = function zyxinfo(type) {
  return new Promise(function (resolve) {
    setTimeout(function () {
      resolve(_ZYX.default[type]);
    }, 500);
  });
};

_vue.default.prototype.$api = { ctky: ctky, czc: czc, grzx: grzx, lyfwfmq: lyfwfmq, lyfwcwd: lyfwcwd, sceniclist: sceniclist, bcfwzyx: bcfwzyx, zyxinfo: zyxinfo };
createApp(app).$mount();
...
component.options.__file = "UAD/zhcx/App.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),
/* 6 */
/*!****************************************************!*\
  !*** D:/UAD/zhcx/App.vue?vue&type=script&lang=js& ***!
  \****************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* 7 */
/*!***********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--12-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!D:/UAD/zhcx/App.vue?vue&type=script&lang=js& ***!
  \***********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _DDT = _interopRequireDefault(__webpack_require__(/*! @/common/DDT.js */ 8));
var _Home = _interopRequireDefault(__webpack_require__(/*! common/Home.js */ 9));
var _utilsFilter = _interopRequireDefault(__webpack_require__(/*! @/pages_CTKY/components/CTKY/shoyu-date/utils.filter.js */ 10));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}var _default =
{
  globalData: {
    //定时上传旅客定位数据
    globalInterval: 0,
    orderNumber: '0',
    uploadMyLocation: function uploadMyLocation() {
      var that = this;
      ...
      uni.getLocation({
        ...
        success: function success(res) {
          uni.request({
            url: _Home.default.Interface.addPassengerPosition.value,
            method: _Home.default.Interface.addPassengerPosition.method,
            data: {
              ...
              lat: res.latitude,
              speed: res.speed,
              reportTime: _utilsFilter.default.timeTodate(_Home.default.dateFormat.dateformat, new Date().getTime()) },
    ...
    constantly: function constantly() {
      var that = this;
...
/* 11 */
/*!************************************************************!*\
  !*** D:/UAD/zhcx/App.vue?vue&type=style&index=0&lang=css& ***!
  \************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* 12 */
/*!****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js??ref--6-oneOf-1-0!./node_modules/css-loader/dist/cjs.js??ref--6-oneOf-1-1!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--6-oneOf-1-2!./node_modules/postcss-loader/src??ref--6-oneOf-1-3!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!D:/UAD/zhcx/App.vue?vue&type=style&index=0&lang=css& ***!
  \****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
